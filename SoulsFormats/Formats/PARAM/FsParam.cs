...
namespace SoulsFormats
{
    ...
    /// </summary>
    public class FsParam : SoulsFile<FsParam>
    {
        /// <summary>
        ...
        public class Row
        {
            ...
            public Row(int id, string name, FsParam parent)
            {
                ID = id;
                Name = name;
                Parent = parent;
            ...
            public Row(Row clone, FsParam newParent)
            {
                Parent = newParent;
                ID = clone.ID;
                Name = clone.Name;
            ...
            {
                var cell = Columns.FirstOrDefault(c => c.Def.InternalName == field);
                if (cell == null)
            ...
            public Cell this[string field]
            {
                get
                {
                    var column = Columns.First(c => c.Def.InternalName == field);
