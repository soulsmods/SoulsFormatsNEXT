...
namespace SoulsFormats.Formats.TAE
{
    public partial class TAE : SoulsFile<SoulsFormats.Formats.TAE.TAE>
    {
        ...
        public class Event
        {
            ...
            /// </summary>
            public SoulsFormats.Formats.TAE.TAE.EventGroup Group { get; set; }
            ...
            /// </summary>
            internal void ApplyTemplate(SoulsFormats.Formats.TAE.TAE containingTae, TAE.Template template,
            ...
            internal void ChangeTemplateAfterLoading(SoulsFormats.Formats.TAE.TAE containingTae, TAE.Template template,
                long animID, int eventIndex, int eventType)
            {
                if (template[containingTae.EventBank].ContainsKey(eventType))
                {
