...
namespace ESDLang.DLSE
{
    public class ESDDLSE : SoulsFile<ESDDLSE>
    {
        ...
        protected override void Write(BinaryWriterEx bw)
        {
            ...
            bw.WriteInt16((short)SharedStrings.Count);
            foreach (var s in SharedStrings)
            {
                bw.WriteInt32(s.Length);
                bw.WriteASCII(s);
            }
            
            // Project
            bw.WriteInt16((short)SharedStrings.IndexOf("EzStateProject"));
            bw.WriteInt32(2);
            bw.WriteInt16((short)SharedStrings.IndexOf("DLVector"));
            bw.WriteInt32(Maps.Count);
        ...
        public class Map
        {
            ...
            internal void Write(BinaryWriterEx bw, List<string> sharedStrings)
            {
                bw.WriteInt16((short)sharedStrings.IndexOf(TypeName));
