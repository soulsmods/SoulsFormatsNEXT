...
{
    internal class Oodle29 : IOodleCompressor
    {
        ...
        [DllImport("oo2core_9_win64", EntryPoint = "OodleLZ_Compress", CallingConvention = CallingConvention.StdCall)]
        ...
        /// <param name="scratchMem">= NULL</param>
        /// <param name="scratchSize">= 0</param>
        [DllImport("liboo2corelinux64.so.9", EntryPoint = "OodleLZ_Compress", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport("oo2core_9_win64", EntryPoint = "OodleLZ_Decompress", CallingConvention = CallingConvention.StdCall)]
        ...
        /// <param name="decoderMemorySize">= 0</param>
        /// <param name="threadPhase">= OodleLZ_Decode_Unthreaded</param>
        [DllImport("liboo2corelinux64.so.9", EntryPoint = "OodleLZ_Decompress", CallingConvention = CallingConvention.StdCall)]
        ...
        /// <returns></returns>
        [DllImport("oo2core_9_win64", EntryPoint = "OodleLZ_GetCompressedBufferSizeNeeded", CallingConvention = CallingConvention.StdCall)]
        ...
        /// <param name="rawSize"></param>
        /// <returns></returns>
        [DllImport("liboo2corelinux64.so.9", EntryPoint = "OodleLZ_GetCompressedBufferSizeNeeded", CallingConvention = CallingConvention.StdCall)]
        ...
        /// <returns></returns>
        [DllImport("oo2core_9_win64", EntryPoint = "OodleLZ_GetDecodeBufferSize", CallingConvention = CallingConvention.StdCall)]
        ...
        /// <param name="corruptionPossible"></param>
        /// <returns></returns>
        [DllImport("liboo2corelinux64.so.9", EntryPoint = "OodleLZ_GetDecodeBufferSize", CallingConvention = CallingConvention.StdCall)]
        ...
        private static long OodleLZ_GetDecodeBufferSize(
            ...
            ? Win64_OodleLZ_GetDecodeBufferSize(unkCompressorArg, rawSize, corruptionPossible)
